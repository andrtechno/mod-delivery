...
<div class="form-group">
    <div class="col-sm-4"><?php echo $form->labelEx($model, 'themename',array('class'=>'control-label')); ?></div>
...
<div class="form-group">
    <div class="col-sm-4"><?php echo $form->labelEx($model, 'from',array('class'=>'control-label')); ?></div>
